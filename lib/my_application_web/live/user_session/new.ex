defmodule MyApplicationWeb.UserSessionLive.New do
  use Phoenix.LiveView

  alias MyApplication.Accounts
  alias MyApplication.Accounts.User
  ...
  def render(assigns),
    do: Phoenix.View.render(MyApplicationWeb.UserSessionView, "new.html", assigns)
